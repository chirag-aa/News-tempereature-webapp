...
const Tempapp = () => {
  ...
  return (
    <>
      <img src="https://indianexpress.com/wp-content/themes/indianexpress/images/indian-express-logo-n.svg" title="The Indian Express" alt="The Indian Express" class="-logo"></img>
